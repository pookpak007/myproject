                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> User Id </th><td> {{ $payment->user_id }} </td></tr><tr><th> Total </th><td> {{ $payment->total }} </td></tr><tr><th> Order Id </th><td> {{ $payment->order_id }} </td></tr><tr><th> Slip </th><td> {{ $payment->slip }} </td></tr>
                                </tbody>
                            </table>
                        </div>
