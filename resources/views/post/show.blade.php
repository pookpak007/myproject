                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> No </th><td> {{ $post->no }} </td></tr><tr><th> Type </th><td> {{ $post->type }} </td></tr><tr><th> Issue Date </th><td> {{ $post->issue_date }} </td></tr><tr><th> Expire Date </th><td> {{ $post->expire_date }} </td></tr><tr><th> Name </th><td> {{ $post->name }} </td></tr><tr><th> Birth Date </th><td> {{ $post->birth_date }} </td></tr><tr><th> Id No </th><td> {{ $post->id_no }} </td></tr><tr><th> User Id </th><td> {{ $post->user_id }} </td></tr>
                                </tbody>
                            </table>
                        </div>
